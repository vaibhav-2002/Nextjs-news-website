...
export default function Layout({ children }) {
  return (
    <div>
      <div className="px-2 md:px-24 bg-blue-600 text-white flex justify-between h-16">
        <Link href="/">
          <a className="text-white uppercase text-2xl flex align-baseline px-10 my-auto">
            <ImEarth className="inline text-4xl mr-4" /> TeleNews
          </a>
        </Link>
      ...
      {children}
      <div className="bg-blue-600 text-white text-xl py-10 px-24 flex flex-col">
        <div>
          <Link href="/">
          <a className="text-white uppercase text-2xl flex align-baseline px-10 my-auto">
            <ImEarth className="inline text-4xl mr-4" /> TeleNews
        ...
        <div className="my-10 text-sm max-w-2xl">
          TeleNews is a open-media and is
